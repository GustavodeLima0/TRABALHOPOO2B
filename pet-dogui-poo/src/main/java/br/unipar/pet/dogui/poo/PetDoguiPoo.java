...
public class PetDoguiPoo {
    ...
    public static void main(String[] args) {
        try {
            ...
            Raca raca;
            raca = new Raca(0, "Labrador");

            cor = corService.insert(cor);
            pelagem = pelagemService.insert(pelagem);
            raca = racaService.insert(raca);

            Cachorro cachorro = new Cachorro(0, "Rex", raca, pelagem, cor, 50.0, true, (java.sql.Date) new Date());
            cachorro = cachorroService.insert(cachorro);
            
            Cachorro cachorro1 = new Cachorro(0, "Max", raca, pelagem, cor, 50.0, true, (java.sql.Date) new Date());
